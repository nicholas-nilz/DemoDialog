...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExer3 = findViewById(R.id.buttonExercise3);
        tvExer3 = findViewById(R.id.textViewExercise3);
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog.OnTimeSetListener myTimeListener = new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        tvDemo5.setText("Time: " + hourIn12HourFormat + ":" + String.format("%02d", minute) + " " + amPm);
                        }
                    };
        ...
        btnDemo5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog.OnTimeSetListener myTimeListener = new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        tvDemo5.setText("Time: " + hourOfDay + ":" + String.format("%02d", minute));
                    }
                };
